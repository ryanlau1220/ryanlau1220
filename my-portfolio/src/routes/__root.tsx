...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'Ryan Lau Jun Hong is a Software Engineering student at Asia Pacific University (APU) building AI systems, middleware, and full-stack solutions.' },
      // Open Graph (Social Previews)
      { property: 'og:type', content: 'website' },
      { property: 'og:title', content: 'Ryan Lau Jun Hong | Portfolio' },
      { property: 'og:description', content: 'Software Engineering student specializing in DevOps, AI automation, and secure Backend architectures.' },
      ...
      { name: 'twitter:description', content: 'Software Engineering student specializing in DevOps, AI automation, and secure Backend architectures.' }
    ],
    links: [
